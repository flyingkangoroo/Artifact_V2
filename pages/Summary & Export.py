...
def create_pdf_report(detailed_info, charts):
    ...
    pdf.cell(0,10, txt="This model was developed as part of a mastersthesis and is currently a prototype. For full reliability, further validation cycles are required.", align='C')
    pdf.ln(20)
